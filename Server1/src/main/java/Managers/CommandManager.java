...
public class CommandManager {
    ...
    public CommandManager(CollectionManager collectionManager,DBManager dbManager) {
        commandCollection.put("add",new Add(console,collectionManager,dbManager));
        commandCollection.put("clear",new Clear(console,collectionManager,dbManager));
        commandCollection.put("show",new Show(console,collectionManager));
        commandCollection.put("removebyid", new RemoveById(console,collectionManager,dbManager));
        ...
        commandCollection.put("insertat",new InsertAt(console,collectionManager,dbManager));
        ...
        commandCollection.put("removelower", new RemoveLower(console,collectionManager,dbManager));
        commandCollection.put("sumofmetersabovesealevel", new SumOfMetersAboveSeaLevel(console,collectionManager));
        commandCollection.put("updateid", new UpdateId(console,collectionManager,dbManager));
        commandCollection.put("register",new Register());
