...
public class City  implements Comparable<City>, Serializable {
     ...
     * @param governor мэр
     */
    public City(Integer id, String name, Coordinates coordinates, Date creationDate, long area, Long population, Long metersAboveSeaLevel, long telephoneCode, Goverment goverment, StandartOfLiving standartOfLiving, Human governor, String username){
        this.id = id;
        this.name=name;
