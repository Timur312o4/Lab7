...
public class GeneratorCity {
     ...
     */
    public static City generate(Scanner scanner,String username) throws IncorrectValueEntryException, NumberFormatException, BuildObjectException, MustBeNotEmptyException {
        while (true) {
            try {
                ...
                City city = new City(id, name, coordinates, creationDate, area, population, metersAboveSeaLevel, telephoneCode, goverment, standartOfLiving, human, username);
